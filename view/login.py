...
with col_esquerda:
    ...
    with container:
        st.write("Pensado e desenvovlido pela EACH-USP")
...
with col_direita:
    ...
    mante_conectador = st.checkbox("Manter conectado por 30 dias")
    st.button("Login ->", width="stretch")
    ...
    with col2:
        ...
        st.button("Faça seu cadastro", width="stretch")
